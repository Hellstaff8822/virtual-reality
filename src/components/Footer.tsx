                    ...
                    <div className="footer__conect">
                        ...
                        <div className="footer-media">
                            <a href='/' className="footer-media__icon">
                                <img src="/assets/icons/footer/ic-facebook.svg" alt="facebook" />
                            </a>
                            <a href='/' className="footer-media__icon">
                                <img src="/assets/icons/footer/ic-twitter.svg" alt="twitter" />
                            </a>
                            <a href='/' className="footer-media__icon">
                                <img src="/assets/icons/footer/ic-instagram.svg" alt="instagram" />
                            </a>
                            <a href='/' className="footer-media__icon">
                                <img src="/assets/icons/footer/ic-pinterset.svg" alt="pinterset" />
                            </a>
                        </div>
                    </div>
