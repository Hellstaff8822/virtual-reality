  ...
  return (
    <div id="blog" className="team">
      ...
      <div className="team__card">
        ...
        <div className="team-item">
          <div className="team-item__icon">
            <img src="/assets/team/Alina.png" alt="Alina" />
          </div>
        ...
        <div className="team-item">
          <div className="team-item__icon">
            <img src="/assets/team/Alex.png" alt="Alex" />
          </div>
          <div className="team-item__info">
